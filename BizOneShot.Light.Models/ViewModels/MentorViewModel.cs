...
namespace BizOneShot.Light.Models.ViewModels
{
    ...
    public class JoinMentorViewModel
    {
        ...
        public string CompNm { get; set; } // 기업이름
        public string RegistrationSn { get; set; }
        public string OwnNm { get; set; }
        public string CompSn { get; set; }

        public string MentorTel { get; set; }
        public string ConCode { get; set; }
        public string ConCodeNm { get; set; }
        public string MentorNm { get; set; }
        public string MentorSn { get; set; }
        public string MappingYn { get; set; }
        public string BaSn { get; set; }
        public string WriterCheck { get; set; }
        public string DeepenComplete { get; set; }
        public string NumSn { get; set; }
        public string SubNumSn { get; set; }

        public string MentorLoginKey { get; set; }
    }
    ...
    public class MentoringTotalReportViewModel
    {
        ...
        public string NumSn { get; set; }
        public string SubNumSn { get; set; }
        public string DeepenContents { get; set; }
        public string FinalSubmitYn { get; set; }
        public string ConCode { get; set; }

        public string FileNm { get; set; }
        public IList<int> FileSn { get; set; }
        ...
        //public IEnumerable<HttpPostedFileBase> sdf {get;set;}
